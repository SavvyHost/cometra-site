      ...
      <main className="w-full md:w-3/4 p-8">
        <div className="mb-8">
          ...
          <div className="relative">
            <input
              className="w-full border-2 border-gray-300 bg-white h-12 px-5 pr-16 rounded-lg text-sm focus:outline-none focus:border-blue-500 transition-colors duration-200"
              type="search"
